...
<html>
  ...
  <body>
    <form action="func.php" onsubmit="return ValidateForm()" name="raftform1" method="POST" class="raftform" >
        <div class="col-sm-9 mx-auto">
            ...
            <div class="form-group">
                <label class="col-form-label-sm">Please select destination for Rafting  </label>
                <select name="destin" class="form-control form-control-sm" required>
                    <option value="Rishikesh">River Ganga, Rishikesh.</option>
                    <option value="Ladakh">KIndus River, Ladakh.(Approximately 25 km) </option>
                    <option value="UK">Bhagirathi River, Uttarakhand.(Approximately 150 km) </option>
                    <option value="AP">Lohit River, Arunachal Pradesh.(Approximately 100 km)</option>
                </select>
            </div>
            <div class="form-group">
                <label for="donebefore?" class="col-form-label-sm">Have you done Rafting before? </label><br>
                <input type="radio" id="html" name="donebefore" value="YES">
                <label for="YES">Yes</label>
                <input type="radio" id="css" name="donebefore" value="NO">
            ...
            <div class="form-group">
                <button type="submit" name="raftform" style="align-self: center;
                margin-top: auto;
                margin-bottom: 20px;
                padding: 10px;
                cursor: pointer;
