...
<html>
  ...
  <body>
    <form action="func.php" onsubmit="return ValidateForm()" name="trekform1" method="POST" class="trekform" >
        <div class="col-sm-9 mx-auto">
            ...
            <div class="form-group">
                <label class="col-form-label-sm">Please select destination for Trekking  </label>
                <select name="destin" class="form-control form-control-sm" required>
                    <option value="HP">Hampta Pass Trek, Himachal Pradesh</option>
                    <option value="Ladakh">Markha Valley Trek, Ladakh</option>
                    <option value="UK">Kuari Pass Trek, Uttrakhand </option>
                </select>
            </div>
            <div class="form-group">
                <label for="donebefore?" class="col-form-label-sm">Have you done Trekking before? </label><br>
            ...
            <div class="form-group">
                <button type="submit" name="trekform" style="align-self: center;
                margin-top: auto;
                margin-bottom: 20px;
                padding: 10px;
                cursor: pointer;
