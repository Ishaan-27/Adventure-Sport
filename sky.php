...
<html>
  ...
  <body>
    <form action="func.php" onsubmit="return ValidateForm()" name="skyform1" method="POST" class="skyform" >
        <div class="col-sm-9 mx-auto">
            ...
            <div class="form-group">
                <label class="col-form-label-sm">Please select destination for Sky Diving  </label>
            ...
            <div class="form-group">
                <label for="donebefore?" class="col-form-label-sm">Have you done Sky Diving before? </label><br>
            ...
            <div class="form-group">
                <button type="submit" name="skyform" style="align-self: center;
                margin-top: auto;
                margin-bottom: 20px;
                padding: 10px;
                cursor: pointer;
