...
<html>
  ...
  <body>
    <form action="func.php" onsubmit="return ValidateForm()" name="paraform1" method="POST" class="paraform" >
        <div class="col-sm-9 mx-auto">
            ...
            <div class="form-group">
                <label class="col-form-label-sm">Please select destination for Paragliding  </label>
                <select name="destin" class="form-control form-control-sm" required>
                    <option value="HP">Bir Billing in Palampur, Himachal Pradesh:</option>
                    <option value="Sikkim">Gangtok, Sikkim</option>
                </select>
            </div>
            <div class="form-group">
                <label for="donebefore?" class="col-form-label-sm">Have you done Paragliding before? </label><br>
            ...
            <div class="form-group">
                <button type="submit" name="paraform" style="align-self: center;
                margin-top: auto;
                margin-bottom: 20px;
                padding: 10px;
                cursor: pointer;
