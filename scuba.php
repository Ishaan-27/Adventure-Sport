...
<html>
  ...
  <body>
    <form action="func.php" onsubmit="return ValidateForm()" name="scubaform1" method="POST" class="scubaform" >
        <div class="col-sm-9 mx-auto">
            ...
            <div class="form-group">
                <label class="col-form-label-sm">Please select destination for Scuba Diving  </label>
                <select name="destin" class="form-control form-control-sm" required>
                    <option value="Andaman">Andaman: The Deep Blue Side</option>
                    <option value="PC">Pondicherry: Underwater Break At Pristine Island</option>
                </select>
            </div>
            <div class="form-group">
                <label for="donebefore?" class="col-form-label-sm">Have you done Scuba Diving before? </label><br>
            ...
            <div class="form-group">
                <button type="submit" name="scubaform" style="align-self: center;
                margin-top: auto;
                margin-bottom: 20px;
                padding: 10px;
                cursor: pointer;
